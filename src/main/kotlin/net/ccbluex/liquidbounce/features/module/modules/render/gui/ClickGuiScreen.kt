...
import net.ccbluex.liquidbounce.features.module.modules.render.gui.SfBoldFontManager
...
class ClickGuiScreen : Screen(Text.literal("ClickGUI")) {
    ...
    override fun init() {
        ...
        // Load SF Bold font synchronously to ensure it's available
        SfBoldFontManager.loadSfBoldFont()
